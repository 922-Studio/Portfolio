    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          {/* Close button — top right outside card on mobile, hidden on desktop (stays inside) */}
          <button
            onClick={close}
            className="sm:hidden absolute -top-1 right-0 z-10 rounded-full bg-white/20 p-2 transition hover:bg-white/30"
            aria-label="Close"
          >
          ...
          >
            ...
            {/* Close button at bottom of card — desktop only */}
            <button
              onClick={close}
              className="hidden sm:flex mx-auto mt-5 items-center justify-center rounded-full bg-white/15 p-2 transition hover:bg-white/25"
              aria-label="Close"
            >
